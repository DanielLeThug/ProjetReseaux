...
public class TestMap : MonoBehaviour
{
	...
	bool Toolbar(MapBehaviour map)
	{
        ...
        if (GUILayout.Button("Save to XML", GUILayout.ExpandHeight(true)))
        {
            ...
            settings.NewLineOnAttributes = true; // Same than before
            XmlWriter writer = XmlWriter.Create("./Assets/Resources/antennas.xml", settings); // This is creation of the XML file and its settings
